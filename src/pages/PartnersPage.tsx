...
function PartnerCard({ partner, featured = false }: { partner: Partner; featured?: boolean }) {
  return (
    <a
      ...
      className={`block bg-surface p-6 wiggly-border hard-shadow hover-wiggle transition-all group ${
        featured ? 'md:col-span-2 lg:col-span-3' : ''
      }`}
    >
      <div className="flex flex-col items-center text-center gap-4">
        <div
          className={`wiggly-border-thin p-3 bg-white overflow-hidden ${
            featured ? 'w-32 h-32' : 'w-20 h-20'
          }`}
        >
          <img
            src={partner.logo}
...
export function PartnersPage() {
  return (
    <div className="flex flex-col">
      ...
      {/* Featured Partner */}
      <section className="px-6 pb-16 max-w-container mx-auto">
      ...
      <section className="px-6 pb-16 max-w-container mx-auto">
        <div className="text-center mb-8">
          <h2 className="font-display text-[24px] text-ink-black">
            Key Partners
          </h2>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-container mx-auto">
          <div className="bg-primary-fixed-dim rounded-[3rem] p-12 md:p-16 text-center relative overflow-hidden wiggly-border-thin hard-shadow-lg">
            <div className="absolute -top-8 -left-8 w-32 h-32 bg-bit-green organic-blob-1 opacity-40" />
            <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-primary-container organic-blob-2 opacity-30" />
            <div className="relative z-10 flex flex-col items-center gap-6 max-w-2xl mx-auto">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-ink-black text-surface font-label font-bold text-[14px] px-8 py-4 wiggly-border hard-shadow-primary hover-wiggle"
              >
                Get in Touch
              </Link>
            </div>
